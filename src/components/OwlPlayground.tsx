      ...
      <div className={styles.grid}>
        ...
        <div className={styles.code}>
          ...
          <p className={styles.note}>
            No network, no canvas and no dependencies: the package is a function
            from a string to SVG markup, and it runs the same in Node as it does
            here. <code>avatarSeed</code> lower-cases and trims, so one person
            keeps one owl across a rename that only changed the capitals.
          </p>
        </div>
      </div>
    </div>
