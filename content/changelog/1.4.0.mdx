...
<Clip src="/changelog/speaking-indicator.mp4" />

Whoever is talking gets a ring in their own colour, and a halo that follows how
loud they are.

![The voice panel beside the chat — nine people, each tile tinted from that person's avatar, with muted and deafened badges](/changelog/voice-split.webp)

![The maximised voice grid — the same call filling the window](/changelog/voice-maximised.webp)

![A shared screen as the main view, with everyone else in a strip above it](/changelog/voice-maximised-share.webp)
...
![A voice tile with a generated avatar, the tile tinted to match it](/changelog/avatar-tile.webp)
