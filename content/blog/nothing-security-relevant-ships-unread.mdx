...
AI can be used anywhere in Gryt. But the areas where a mistake hurts you — the SFU, authentication and identity, the client's key handling, the image worker, the data layer — can only change through a pull request that I read line by line before merging. No direct commits, no exceptions for small changes.

Everything else — docs, this site, the interface, tooling — is reviewed like any normal change.
