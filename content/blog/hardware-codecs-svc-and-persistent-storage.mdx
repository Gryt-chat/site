...
If you want to dig into the implementation details, the [SFU documentation](https://docs.gryt.chat/docs/host/sfu) covers the Dependency Descriptor parser and layer-aware forwarding, and [Performance Tuning](https://docs.gryt.chat/docs/use/troubleshooting) has the full screen share settings reference. Questions or feedback? Come hang out on [Discord](https://gryt.chat/discord).
