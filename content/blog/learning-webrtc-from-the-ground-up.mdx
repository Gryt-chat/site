...
If you want to dig into the Gryt SFU implementation or have questions about WebRTC, come chat on [Discord](https://gryt.chat/discord) or open an issue on [GitHub](https://github.com/Gryt-chat/gryt).
