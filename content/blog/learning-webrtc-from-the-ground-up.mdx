...
## Why I didn't just use a library

When I started building Gryt, the pragmatic move would have been to grab a WebRTC-as-a-service SDK, wire it up, and call it done. Plenty of good ones exist. But I had a nagging feeling that if I was going to build a voice platform I could stand behind, I needed to understand what was actually happening on the wire.
...
I chose to build the SFU in **Go** using the [Pion WebRTC](https://github.com/pion/webrtc) library. Pion is remarkable — it's a pure Go implementation of the WebRTC stack, no C dependencies, no CGo. This meant I could:
...
Building on Pion was one of the best learning decisions I made. When something broke, I could trace it from the application layer all the way down to individual RTP packets.
...
Two years is a long time to spend learning a protocol. But that investment shows up everywhere in Gryt today:
...
![Gryt voice chat in action — three users connected with real-time latency displayed, text chat, and voice controls](/gryt-preview.png)
