...
For production deployments on a VPS or cloud server, [Docker Compose](https://docs.gryt.chat/docs/host/docker-compose) is still the recommended path. It gives you automatic restarts, easier TLS setup, and a more standard ops workflow.
...
Full setup instructions, firewall configuration, and troubleshooting are in the [Windows deployment guide](https://docs.gryt.chat/docs/host/windows).
