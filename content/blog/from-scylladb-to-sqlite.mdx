...
author: Sivert
date: 2026-02-28
image: /blog/art-scylla-to-sqlite.webp
tags:
  - infrastructure
  - self-hosting
  - technical
...
The server uses [better-sqlite3](https://github.com/WiseLibs/better-sqlite3), a synchronous C binding with no async overhead and no connection pool management. Queries run on the calling thread and return immediately. For the kind of workload Gryt generates, dozens to hundreds of concurrent users rather than millions, this is more than enough.
...
Questions about the migration or want to host your own server? Check the [deployment guide](https://docs.gryt.chat/docs/host/docker-compose), or come chat on [our Gryt server](https://gryt.chat/community) or [Discord](https://gryt.chat/discord).
