...
Questions about the migration or want to host your own server? Check the [deployment guide](https://docs.gryt.chat/docs/deployment/docker-compose) or come chat on [Discord](https://gryt.chat/discord).
