...
Questions about the migration or want to host your own server? Check the [deployment guide](https://docs.gryt.chat/docs/host/docker-compose) or come chat on [Discord](https://gryt.chat/discord).
