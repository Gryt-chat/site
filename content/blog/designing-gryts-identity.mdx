...
![First revamp of the login screen, a dark form card against flowing blue waves, January 2023](/blog/first_revamped_login_screen.webp)
...
![First sketch of the full server layout, the "Gryta krutt" server with text channels, voice channels, and category sections, early 2023](/blog/first_ever_sketch.webp)
...
![First sketch of the user card, with profile banner, avatar, role badges, status, and action buttons, early 2023](/blog/first_ever_sketch_user_card.webp)
...
![First sketch of the expanded profile, with cover image, avatar, badges, about me section, and linked social accounts, early 2023](/blog/first_ever_sketch_of_detailed_profile.webp)
...
![Second revamp of the login, the owl mascot peeking in from the corner, a pink login button adding playfulness, March 2023](/blog/second_revamp_of_login.webp)
...
![The web login page alongside the first Gryt desktop client, scattered icons on the background, the owl front and centre with an "Authenticate" button, March 2023](/blog/first_screenshot_of_new_login_with_first_client.webp)
...
![Logo variations, the Gryt owl in light and dark variants across nine colour combinations, including a beret edition and a rainbow background](/blog/Logos.webp)
...
![Second iteration of the user card, with pixel art banner, refined layout, and the members list visible alongside, April 2023](/blog/second_ever_sketch_profile_card.webp)
...
![Second iteration of the expanded profile, with painted sky banner and an updated badge system including a Supporter tier, April 2023](/blog/second_sketch_of_expanded_profile.webp)
...
![The Gryt Design System in Figma, with component library, colour tokens, typography, app screens, and avatar collections, April 2023](/blog/figma_screenshot.webp)
...
![Dashboard editing mode, an "Add New Card" dialog with widget options like unread messages, favorite friends, and message stats, plus a live preview, April 2023](/blog/first_sketch_of_dashboard_editing.webp)
