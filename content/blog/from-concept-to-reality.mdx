...
![The first prototype layout — running on a local network at 192.168.10.155:8010, showing a minimal server/channel/chat layout, November 15, 2024](/first_ever_new_layout_prototype.png)
...
![First UI update — running at webrtc.sivert.io, showing "Server Name" with "Channel #1", a connected user, voice controls, and a chat input, November 17, 2024](/first_update_of_ui.png)
