...
You can read the full details on the [licensing page](https://docs.gryt.chat/docs/about/licensing).
...
If you have any questions about the license change, check out the [licensing docs](https://docs.gryt.chat/docs/about/licensing) or reach out on [Discord](https://gryt.chat/discord).
