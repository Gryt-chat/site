...
description: Why Gryt moved from MIT to AGPL-3.0, and why I wiped the git history in the process.
author: Sivert
date: 2026-02-22
tags:
  - gryt
...
- If you want to use Gryt commercially without those obligations, you need a [commercial license](mailto:sivert@gryt.chat).

You can read the full details on the [licensing page](https://docs.gryt.chat/docs/guide/licensing).
